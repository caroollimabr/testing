...
public class DBController {
	...
	public ResponseEntity<String> popula() {
		...
		Usuario cigano = new Usuario("sicrano", "sicrano@gmail.com", encoder.encode("pass"));
		cigano.setRole("ROLE_ADMIN");
		cigano.activa();
		
		Leilao leilaoTablet = new Leilao("Tablet Bla bla",new BigDecimal("5.0"), fulano);
		...
		Leilao leilaoSemLance = new Leilao("Computador 123", new BigDecimal("500.0"), beltrano);
		leiloes.save(leilaoSemLance);


		return ResponseEntity.ok("{'message':'dados populados'}");
	}
