...
public class StepDefinitions {
    ...
    private static final int DEFAULT_RANGE = 100; //representa localização
    private String messageFromSean;
    private Network network = new Network(DEFAULT_RANGE);
    private Map<String, Person> people; //cria um map de nomes, ao invés de colocar nomes fixos nos cenários


    static class Whereabouts {  //classe para os data tables, que permitem que vc escolha os valores no arquivo.feature
        public String name;
    ...
    @DataTableType // converte a table numa lista de objetos Whereabouts
    ...
    //@Given("Lucy is located/standing {int} meter(s) from Sean") --- Cucumber expression
    ...
    public void people_are_located_at(@Transpose List<Whereabouts> whereabouts) { //@Transpose permite usar os headers na primeira coluna de uma tabela
    ...
    public void lucy_hears_the_following_messages(DataTable expectedMessages) {
        ...
        expectedMessages.diff(DataTable.create(actualMessages)); // diff compara duas tabelas
    }
}
